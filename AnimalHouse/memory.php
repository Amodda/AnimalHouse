...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top mb-5 shadow">
        ...
        <div class="container d-flex justify-content-center align-items-center my-4" >
          <div class="w-75 bg-light my-4 d-flex flex-column align-items-center  rounded shadow" id="memory">
              <div class="d-flex w-75 m-3 justify-content-center align-items-center">
                  <h4 class="mx-3">Memory</h4>
                 
              </div>
              <div class="flex-column align-items-center justify-content-center my-4 w-100" style="display: flex;" id="startView">
                <p class="w-50 mb-4">Guess the couple of cards about thousands of animals! Finish the cards before the time's up!</p>
                <?php
                  if(isset($_SESSION['user'])){
              ...
              <div class="w-75 flex-column justify-content-center align-items-center my-4" style="display: none;" id="memoryView">
                  <div class="w-100 d-flex justify-content-center align-items-center my-3" >
                    <h5 id="timer"></h5>
                  </div>
                  <div class="my-2 w-100 d-flex flex-column align-items-center justify-content-center" id="memoryCards">
                    <div class="my-2 w-100 d-flex flex-row align-items-center justify-content-center" id="cardRow1">
                    </div>
                    <div class="my-2 w-100 d-flex flex-row align-items-center justify-content-center" id="cardRow2">
                    </div>
                  </div>
              ...
              <div class="w-75 flex-column justify-content-center align-items-center my-4" id="memoryEnd" style="display: none;">
